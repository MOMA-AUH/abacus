...
<!--  # Test summary - leftout because we're only allowed to look a specific gene(s) -->
...
```{r Color comment , results = "asis",eval=FALSE,include=FALSE}
...
```{r Summary Table, results = TRUE,eval=FALSE,include=FALSE}
