...
cat("\n\n")
cat('<span style="color:red;">**WARNING! ALL ABACUS GENES ARE INCLUDED IN THE REPORT. REMEBER TO ONLY LOOK AT THE GENE(S) THAT YOU HAVE PERMISSION FOR, i.e. GENE(S) THAT IS/ARE REQUESTED!**</span>')
...
for (i in seq_len(nrow(regions))) {
  ...
  # TDA: adding a tab before the first region, specifying that only the specific gene(s) that is/are requested can be viewed!
  if( i == 1){
  cat("\n\n")
  cat('## **Genes:** {.tabset .tabset-pills}')
  cat("\n\n")
