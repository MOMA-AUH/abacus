...
for (i in seq_len(nrow(regions))) {
  ...
  cat("A histogram showing the number of occurences of the individual $k$-mers. Is more than one $k$-mer is present in the pattern one histogram is shown for each $k$-mer. QC filtered reads are not shown in the grouped plot.")
